    ...
    public void addSearchEdgeUI(GridPane gridPane, String str){
        ...
        SearchButton.setOnAction(_ -> {
            if(nameField.getText().isEmpty()) {
                ...
                showAlert(Alert.AlertType.ERROR, gridPane.getScene().getWindow(), "Error!", "Please enter name");
            }else if(graph.SearchNode(nameField.getText())=="Node not Found"||graph.SearchNode(toField.getText())=="Node not Found") {
...
//                }
//
//                Stack<String> path = flooding.animatePathfl(source, target);
//                if (path == null) {
    ...
    public void animateFloodGui(Pane pane) {
        ...
        EventHandler<ActionEvent> newEvent = _ -> {
            ...
            searchButton.setOnAction(_ -> {
                ...
                for (Edge edge : graph.getEdges()) {
                    flood.addEdge(edge.source, edge.destination, edge.weight);
                }
